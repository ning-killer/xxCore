...
typedef XCIOT_BYTES_ARRAY_T(40960) ipc_HistoryThumGet_Resp_thum_body_t;
...
typedef XCIOT_BYTES_ARRAY_T(50) ipc_MotionzoneGet_Resp_mz_t;
...
typedef XCIOT_BYTES_ARRAY_T(524288) ipc_Screenshot_Resp_body_t;
