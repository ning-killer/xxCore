...
//设备在线状态
typedef enum enum_ZJ_AI_ONLINE_STATUS
{
   EN_ZJ_AI_ONLINE_STATUS_OFFLINE  = 0x0000,//设备未上线
   EN_ZJ_AI_ONLINE_STATUS_ONLINE   = 0x0001,//设备已上线
}EN_ZJ_AI_ONLINE_STATUS;
...
//设置设备在线情况
int ZJ_AI_SetOnlineStatus(EN_ZJ_AI_ONLINE_STATUS enOnlineStatus);

//设备设置取流配置
int ZJ_AI_SetVideoStreamConfig(unsigned char* pucStreamConfigPath, unsigned char* pucExtInfo);
