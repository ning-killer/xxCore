...
#include <netdb.h>
CARES_EXTERN int hy_getaddrinfo(const char *node, const char *service, const struct addrinfo *hints, struct addrinfo **res);

CARES_EXTERN void hy_freeaddrinfo(struct addrinfo *res);
