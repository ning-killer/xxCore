...
typedef struct tsVPSS_LDC_ATTR_S {
    TS_BOOL     bEnable;                        /* RW; Range: [0, 1]; Whether LDC is enbale */
    LDC_ATTR_S  stAttr;
} VPSS_LDC_ATTR_S;


typedef struct tsVPSS_LDCV3_ATTR_S {
    TS_BOOL     bEnable;                        /* RW;Whether LDC is enbale */
    LDCV3_ATTR_S  stAttr;
} VPSS_LDCV3_ATTR_S;

typedef struct tsVPSS_ROTATION_EX_ATTR_S {
    TS_BOOL       bEnable;                      /* Whether ROTATE_EX_S is enbale */
    ROTATION_EX_S stRotationEx;                 /* Rotate Attribute */
} VPSS_ROTATION_EX_ATTR_S;

typedef struct tsVPSS_LOW_DELAY_INFO_S {
    TS_BOOL bEnable;          /* RW; Low delay enable. */
    TS_U32 u32LineCnt;        /* RW; Range: [16, 16384]; Low delay shoreline. */
} VPSS_LOW_DELAY_INFO_S;

typedef struct tsVPSS_EXT_CHN_ATTR_S {
...
typedef struct tsVPSS_GRP_SHARPEN_MANUAL_ATTR_S {
    ...
    TS_U8  u8DetailCtrlThr;
} VPSS_GRP_SHARPEN_MANUAL_ATTR_S;


typedef struct tsVPSS_GRP_SHARPEN_AUTO_ATTR_S {
    /* RW; Range: [0, 4095]; Undirectional sharpen strength for texture and detail enhancement */
    TS_U16 au16TextureStr[VPSS_SHARPEN_GAIN_NUM][VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 4095]; Directional sharpen strength for edge enhancement */
    TS_U16 au16EdgeStr[VPSS_SHARPEN_GAIN_NUM][VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 4095]; Texture frequency adjustment. Texture and detail will be finer when it increase */
    TS_U16 au16TextureFreq[VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 4095]; Edge frequency adjustment. Edge will be narrower and thiner when it increase */
    TS_U16 au16EdgeFreq[VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 127]; u8OvershootAmt */
    TS_U8  au8OverShoot[VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 127]; u8UndershootAmt */
    TS_U8  au8UnderShoot[VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 255]; overshoot and undershoot suppression strength,
        the amplitude and width of shoot will be decrease when shootSupSt increase */
    TS_U8  au8ShootSupStr[VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 255]; Different sharpen strength for detail and edge.
        When it is bigger than 128, detail sharpen strength will be stronger than edge. */
    TS_U8  au8DetailCtrl[VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 63]; Edge smooth strength. */
    TS_U8  au8EdgeFiltStr[VPSS_AUTO_ISO_STRENGTH_NUM];
    /* RW; Range: [0, 255]; The threshold of DetailCtrl, it is used to distinguish detail and edge. */
    TS_U8  au8DetailCtrlThr[VPSS_AUTO_ISO_STRENGTH_NUM];
} VPSS_GRP_SHARPEN_AUTO_ATTR_S;


typedef struct tsVPSS_GRP_SHARPEN_ATTR_S {
    ...
    TS_U8                           au8LumaWgt[VPSS_YUV_SHPLUMA_NUM];
...
typedef struct {
    ...
    TS_U16 STH1 : 9,  SFN1 : 3, SFN0  : 3, NRyEn : 1;
    ...
    TS_U16 STH2 : 9,  SFN2 : 3, BWSF4 : 1, kMode : 3;
    ...
    TS_U16 STH3 : 9,  SFN3 : 3, tEdge : 2, TriTh : 1, _rb_  : 1;
} tV56aSFy;
...
typedef struct {
    ...
    TS_U16 MADZ : 10, MAI0 : 2, MAI1 : 2,  MAI2 : 2;
    ...
    TS_U8  MASW :  4, MABW : 3, MAXN : 1, _rB_;
} tV56aMDy;
...
typedef struct {
    ...
    TS_U8  TFR[5],   TSS : 4,  TSI : 1, _rb_ : 2;
...
typedef struct {
    ...
    TS_U16 SBSk2[32], SDSk2[32];
    /* SBSk3[32], SDSk3[32]; Range [0, 8192];  Spatial NR strength based on brightness. */
    TS_U16 SBSk3[32], SDSk3[32];
} VPSS_NRX_V1_S;


typedef struct tsVPSS_NRX_PARAM_MANUAL_V1_S {
    VPSS_NRX_V1_S stNRXParam;
} VPSS_NRX_PARAM_MANUAL_V1_S;


typedef struct tsVPSS_NRX_PARAM_AUTO_V1_S {
    TS_U32 u32ParamNum;
    TS_U32 *pau32ISO;
...
typedef struct tsVPSS_NRX_PARAM_V1_S {
...
typedef struct {
    ...
    TS_U16 SRT0 : 5, SRT1 : 5, JMODE : 3,  DeIdx : 3;
...
typedef struct {
    ...
    TS_U16 MADZ0   : 9,  MAI00    : 2,  MAI01  : 2,  MAI02    : 2,  biPath  : 1;
    TS_U16 MADZ1   : 9,  MAI10    : 2,  MAI11  : 2,  MAI12    : 2,  _rb0_ : 1;
    TS_U8  MABR0, MABR1;

    /* MATH0,MATH1;   Range: [0, 999]; The theshold for motion detection. */
    /* MATE0,MATE1;   Range: [0,   8]; The motion index for smooth image area. */
    /* MATW;   Range: [0,   3]; The motion index for prevention of motion ghost. */
    TS_U16 MATH0   : 10,  MATE0   : 4,  MATW   : 2;
    TS_U16 MATH1   : 10,  MATE1   : 4,  _rb1_  : 2;


    /* MASW;   Range: [0,  15]; The motion index for low-frequency noises. */
    /* MABW0,MABW1;   Range: [0,   9]; The window size for motion detection. */
    TS_U8  MASW    :  4,  _rb2_   : 4;
    TS_U8  MABW0   :  4,  MABW1   : 4;
} tV500_VPSS_MDy;
...
typedef struct {
    ...
    TS_U16 TFS0  :  4, TDZ0   : 10, TDX0    : 2;
    TS_U16 TFS1  :  4, TDZ1   : 10, TDX1    : 2;
    ...
    TS_U16 SDZ0  : 10, STR0   : 5,  DZMode0 : 1;
    TS_U16 SDZ1  : 10, STR1   : 5,  DZMode1 : 1;
    ...
    TS_U8  TFR0[6],    TSS0   : 4,  TSI0    : 4;
    TS_U8  TFR1[6],    TSS1   : 4,  TSI1    : 4;
    ...
    /* bRef;             Range: [0,   1]; The Switch for temproal filtering. */
    TS_U8  RFI   : 3,  tEdge  : 2,  bRef    : 1,  _rb_ : 2;
} tV500_VPSS_TFy;
...
typedef struct {
    ...
    TS_U16 advMATH : 1, RFDZ  : 9,    _rb_ : 6;
...
typedef struct tsVPSS_NRX_PARAM_MANUAL_V2_S {
    VPSS_NRX_V2_S stNRXParam;
} VPSS_NRX_PARAM_MANUAL_V2_S;

typedef struct tsVPSS_NRX_PARAM_AUTO_V2_S {
    TS_U32 u32ParamNum;
    TS_U32 *pau32ISO;
    VPSS_NRX_V2_S *pastNRXParam;
} VPSS_NRX_PARAM_AUTO_V2_S;

typedef struct tsVPSS_NRX_PARAM_V2_S {
    OPERATION_MODE_E           enOptMode;           /* RW;Adaptive NR */
...
typedef struct {
    ...
    TS_U8  IES0, IES1, IES2, IES3;
    /* IEDZ   ; Range: [0, 999]; The threshold to control the generated artifacts. */
    TS_U16  IEDZ : 10, IEEn : 1, _rb_ : 5;
} tV200_VPSS_IEy;

typedef struct {
    TS_U8  SPN6 : 3, SFR  : 5;                                      /* SPN6, SBN6:  [0, 5]; */

    TS_U8  SBN6 : 3, PBR6 : 5;                                    /* SFR: [0,31];  PBR6: [0,15]; */
    ...
    /* SBSk[32], SDSk[32]; Range [0, 8191];  Spatial NR strength based on brightness. */
    TS_U16  STH1 : 9,  SFN1 : 3, SFN0  : 3, NRyEn   : 1;
    TS_U16  STHd1 : 9, _rb0_ : 7;
    TS_U16  STH2 : 9,  SFN2 : 3, kMode : 3, _rb1_   : 1;
    TS_U16  STHd2 : 9, _rb2_ : 7;
    TS_U16  SBSk[32], SDSk[32];
} tV200_VPSS_SFy;
...
typedef struct {
    ...
    /* TSS0,TSS1;          Range: [0,  15]; The ratio for blending spatial NR with the temproal NR results. */
    /* TSI0,TSI1;          Range: [0,   1]; The selection of blending filter for TSS. */
    TS_U8  TSS0 : 4,   TSI0 : 4,  TFR0[6];
    TS_U8  TSS1 : 4,   TSI1 : 4,  TFR1[6];
    ...
    TS_U8  TFRS : 4,   TED  : 2,   bRef    : 1,  _rb_ : 1;
} tV200_VPSS_TFy;
...
typedef struct {
    ...
    /* MADZ0, MADZ1;     Range: [0, 511]; The blending ratio between MAI2 and MAI1 based on image statistics. */
    /* MAI00~02,MAI10~12 Range: [0,   3]; The three blending results between spatial and temporal filtering. */
    TS_U16  MADZ0   : 9,   MAI00 : 2,  MAI01  : 2, MAI02 : 2, _rb0_ : 1;
    TS_U16  MADZ1   : 9,   MAI10 : 2,  MAI11  : 2, MAI12 : 2, _rb1_ : 1;
    /* MABR0, MABR1;     Range: [0, 255]; The blending ratio between MAI2 and MAI1 based on brightness.  */
    TS_U8  MABR0, MABR1;
    ...
    /* MABW0,MABW1;   Range: [0,   9]; The window size for motion detection. */
    TS_U16  MATH0   : 10,  MATE0 : 4,  MATW   : 2;
    TS_U16  MATHd0  : 10,  _rb2_ : 6;
    TS_U16  MATH1   : 10,  _rb3_ : 6;
    TS_U16  MATHd1  : 10,  _rb4_ : 6;
    TS_U8  MASW    :  4,  MATE1 : 4;
    TS_U8  MABW0   :  4,  MABW1 : 4;
...
typedef struct tsVPSS_NRX_PARAM_MANUAL_V3_S {
    VPSS_NRX_V3_S stNRXParam;
} VPSS_NRX_PARAM_MANUAL_V3_S;

typedef struct tsVPSS_NRX_PARAM_AUTO_V3_S {
    TS_U32 u32ParamNum;
    TS_U32 *pau32ISO;
    VPSS_NRX_V3_S *pastNRXParam;
} VPSS_NRX_PARAM_AUTO_V3_S;

typedef struct tsVPSS_NRX_PARAM_V3_S {
    OPERATION_MODE_E           enOptMode;           /* RW;Adaptive NR */
...
typedef struct tsVPSS_GRP_NRX_PARAM_S {
...
typedef struct tsVPSS_CHN_BUF_WRAP_S {
    TS_BOOL bEnable;
    TS_U32  u32BufLine;             /* RW; Range: [128, H]; Chn buffer allocated by line. */
    TS_U32  u32WrapBufferSize; /* RW; Whether to allocate buffer according to compression. */
} VPSS_CHN_BUF_WRAP_S;

typedef struct tsVPSS_PARAM_MOD_S {
    TS_BOOL bOneBufForLowDelay;
    TS_U32  u32VpssVbSource;
    TS_U32  u32VpssSplitNodeNum;
    TS_BOOL bHdrSupport;
    TS_BOOL bNrQuickStart;
} VPSS_MOD_PARAM_S;

typedef enum tsVPSS_CHN_PROC_MODE_E {
