 ...
 * Description: ts_securec.h
 * Author:TsingMicro multimedia software group
 * Create: 2022/06/02
 */

#ifndef __TS__SECUREC_H__5D13A042_DC3F_4ED9_A8D1_882811274C27
#define __TS__SECUREC_H__5D13A042_DC3F_4ED9_A8D1_882811274C27
...
extern "C"
{
    ...
    */
    static inline int ts_wmemcpy(wchar_t* dest, size_t destMax, const wchar_t* src, size_t count)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_memmove(void* dest, size_t destMax, const void* src, size_t count)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_wmemmove(wchar_t* dest, size_t destMax, const wchar_t* src, size_t count)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_wcscpy(wchar_t* strDest, size_t destMax, const wchar_t* strSrc)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_wcsncpy(wchar_t* strDest, size_t destMax, const wchar_t* strSrc, size_t count)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_wcscat(wchar_t* strDest, size_t destMax, const wchar_t* strSrc)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_wcsncat(wchar_t* strDest, size_t destMax, const wchar_t* strSrc, size_t count)
    {
    ...
    */
    static inline char* ts_strtok(char* strToken, const char* strDelimit, char** context)
    {
    ...
    * @return:returns a pointer to the first character of a token, or a null pointer if there is no token or there is a runtime-constraint violation.
    */
    #define ts_wcstok(strToken, strDelimit, context) \
    ...
    */
    #define ts_sprintf(strDest, destMax, format, ...) \
    ...
    */
    #define ts_swprintf(strDest, destMax, format, ...) \
    ...
    */
    #define ts_snprintf(strDest, destMax, count, format, ...) \
    ...
    */
    #define ts_scanf(format, ...) scanf_s(format, ##__VA_ARGS__)
    ...
    * @return:returns the number of input items assigned, If an error occurred return -1.
    */
    #define ts_wscanf(format, ...) wscanf_s(format, ##__VA_ARGS__)
    ...
    * @return:returns the number of input items assigned, If an error occurred return -1.
    */
    #define ts_fscanf(stream, format, ...) fscanf_s(stream, format, ##__VA_ARGS__)
    ...
    * @return:returns the number of input items assigned, If an error occurred return -1.
    */
    #define ts_fwscanf(stream, format, ...) fwscanf_s(stream, format, ##__VA_ARGS__)
    ...
    * @return:returns the number of input items assigned, If an error occurred return -1.
    */
    #define ts_sscanf(buffer, format, ...) sscanf_s(buffer, format, ##__VA_ARGS__)
    ...
    * @return:returns the number of input items assigned, If an error occurred return -1.
    */
    #define ts_swscanf(buffer, format, ...) swscanf_s(buffer, format, ##__VA_ARGS__)
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline char* ts_gets(char* buffer, size_t destMax)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_memset(void* dest, size_t destMax, int c, size_t count)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_memcpy(void* dest, size_t destMax, const void* src, size_t count)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_strcpy(char* strDest, size_t destMax, const char* strSrc)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_strncpy(char* strDest, size_t destMax, const char* strSrc, size_t count)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_strcat(char* strDest, size_t destMax, const char* strSrc)
    {
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    static inline int ts_strncat(char* strDest, size_t destMax, const char* strSrc, size_t count)
    {
...
#endif/* __TS__SECUREC_H__5D13A042_DC3F_4ED9_A8D1_882811274C27 */
