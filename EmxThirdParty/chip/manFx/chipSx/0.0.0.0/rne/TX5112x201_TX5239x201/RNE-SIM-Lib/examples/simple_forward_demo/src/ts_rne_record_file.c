...
TS_S32 TS_MPI_TRP_RNE_RecordHwcPFile(TS_S32 frameIndex, TS_S32 frameCount, RNE_BLOBS_S *debug, TS_CHAR *debugLayerName,
...
TS_S32 TS_MPI_TRP_RNE_RecordHwcFile(TS_S32 frameIndex, TS_S32 frameCount, RNE_BLOBS_S *debug, TS_CHAR *debugLayerName,
                                    TS_CHAR *outputPath, TS_CHAR *debugName, TS_S32 outType)
{
    for (TS_U32 idx = 0; idx < debug->u32NBlob; idx++) {
        THIS_IS_SAME_CODE
...
#ifndef DISABLE_PRINT_DEBUG_LAYER
                                printf(format, data & MASK_BITS(bitNum));
#endif
                                fprintf(file, format, data & MASK_BITS(bitNum));
                            } else {
                                TS_S32 bitNum = (debug->stpBlob[idx].s32BitNum - 1);
                                TS_S32 bitValue = MASK_BITS(bitNum);
                                if (!is_unsign && data > bitValue) {
...
TS_S32 TS_MPI_TRP_RNE_RecordChwPFile(TS_S32 frameIndex, TS_S32 frameCount, RNE_BLOBS_S *debug, TS_CHAR *debugLayerName,
                                     TS_CHAR *outputPath, TS_CHAR *debugName, TS_S32 outType)
{
    for (TS_U32 idx = 0; idx < debug->u32NBlob; idx++) {
        THIS_IS_SAME_CODE
...
TS_S32 TS_MPI_TRP_RNE_RecordChwFile(TS_S32 frameIndex, TS_S32 frameCount, RNE_BLOBS_S *debug, TS_CHAR *debugLayerName,
                                    TS_CHAR *outputPath, TS_CHAR *debugName, TS_S32 outType)
{
    for (TS_U32 idx = 0; idx < debug->u32NBlob; idx++) {
        THIS_IS_SAME_CODE
...
TS_S32 TS_MPI_TRP_RNE_RecordFile(TS_S32 frameIndex, TS_S32 frameCount, RNE_BLOBS_S *debug, TS_CHAR *debugLayerName,
                                 TS_CHAR *outputPath, const TS_CHAR *type)
{
    ...
    TS_MPI_TRP_RNE_RecordHwcPFile(frameIndex, frameCount, debug, debugLayerName, outputPath, debugName, outType);
    TS_MPI_TRP_RNE_RecordHwcFile(frameIndex, frameCount, debug, debugLayerName, outputPath, debugName, outType);
    TS_MPI_TRP_RNE_RecordChwPFile(frameIndex, frameCount, debug, debugLayerName, outputPath, debugName, outType);
    TS_MPI_TRP_RNE_RecordChwFile(frameIndex, frameCount, debug, debugLayerName, outputPath, debugName, outType);
