...
typedef enum tsRNE_NET_INPUT_TYPE_E {
    RNE_NET_INPUT_TYPE_FLOAT32_HWC,
    RNE_NET_INPUT_TYPE_FLOAT32_CHW,
    RNE_NET_INPUT_TYPE_INT8_HWC,
    RNE_NET_INPUT_TYPE_INT8_CHW,
    RNE_NET_INPUT_TYPE_FORMAT_0RGB,
    RNE_NET_INPUT_TYPE_FORMAT_GREY
 ...
 */
TS_S32 TS_MPI_TRP_RNE_CStride(TS_S32 chan, TS_S32 bitNum, TS_BOOL isJoined);
