...
typedef struct {
    ...
    hi_u8 full_mdt_sig_g_wgt;
    hi_u8 full_mdt_sig_rb_wgt;
...
typedef union {
    ...
    struct {
        ...
        hi_u64 bit1_dpc : 1; /* [8] */
        hi_u64 bit1_lsc : 1; /* [9] */
        hi_u64 bit1_r_lsc : 1; /* [10] */
        hi_u64 bit1_ge : 1; /* [11] */
        hi_u64 bit1_anti_false_color : 1; /* [12] */
        hi_u64 bit1_bayer_nr : 1; /* [13] */
        hi_u64 bit1_split : 1; /* [14] */
        hi_u64 bit1_ca : 1; /* [15] */
        hi_u64 bit1_clut : 1; /* [16] */
        hi_u64 bit1_log_lut : 1; /* [17] */
        hi_u64 bit1_pre_log_lut : 1; /* [18] */
        hi_u64 bit1_wdr : 1; /* [19] */
        hi_u64 bit1_awb : 1; /* [20] */
        hi_u64 bit43_rsv : 43; /* [21:63] */
    };
} hi_isp_cmos_alg_key;
