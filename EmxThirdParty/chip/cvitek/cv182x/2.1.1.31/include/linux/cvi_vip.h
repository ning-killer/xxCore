...
#define V4L2_CID_DV_VIP_SC_SET_RGN_LUT          (V4L2_CID_DV_VIP_SC_BASE + 6)
#define V4L2_CID_DV_VIP_SC_SET_COEF             (V4L2_CID_DV_VIP_SC_BASE + 7)
#define V4L2_CID_DV_VIP_SC_SET_CUSTOM_CSC       (V4L2_CID_DV_VIP_SC_BASE + 8)
#define V4L2_CID_DV_VIP_SC_SET_VPSS_CHN_CFG     (V4L2_CID_DV_VIP_SC_BASE + 9)
#define V4L2_CID_DV_VIP_SC_SET_BIND_FB          (V4L2_CID_DV_VIP_SC_BASE + 10)
...
enum V4L2_CID_DV_VIP_ISP {
	...
	V4L2_CID_DV_VIP_ISP_GET_PROC_INFO,
	...
	V4L2_CID_DV_VIP_ISP_START_SMOOTH_RAW_DUMP,
	V4L2_CID_DV_VIP_ISP_STOP_SMOOTH_RAW_DUMP,
	V4L2_CID_DV_VIP_ISP_GET_SMOOTH_RAW_DUMP,
	V4L2_CID_DV_VIP_ISP_PUT_SMOOTH_RAW_DUMP,
	V4L2_CID_DV_VIP_ISP_GET_CLUT_TBL_IDX,
};
