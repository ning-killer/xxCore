						...
						DATA_BITWIDTH_E enBitWidth, COMPRESS_MODE_E enCmpMode, CVI_U32 u32Align)
{
    ...
    CVI_U32 tmpW = (u32Width+63)/64*64;
    CVI_U32 tmpH = (u32Height+63)/64*64;
	COMMON_GetPicBufferConfig(tmpW, tmpH, enPixelFormat, enBitWidth, enCmpMode, u32Align, &stCalConfig);
...
static inline CVI_U32 COMMON_GetVencFrameBufferSize(CVI_S32  s32Codec, CVI_U32  u32Width, CVI_U32  u32Height)
{
	...
	if (s32Codec == PT_H264) {
		...
		u32RetSize = ROUND_UP(u32RetSize, 4096);
	} else
		u32RetSize = 0;
