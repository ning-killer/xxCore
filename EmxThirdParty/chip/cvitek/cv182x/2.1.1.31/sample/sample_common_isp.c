...
ISP_PUB_ATTR_S ISP_PUB_ATTR_F38P_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 }, 25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_K06_4M_25FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 }, 25, BAYER_GBRG, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS02H10_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS03B10_3M_30FPS = { { 0, 0, 2304, 1296 }, { 2304, 1296 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS04A10_4M_1440P_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS04C10_4M_30FPS = { { 0, 0, 2688, 1520 }, { 2688, 1520 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS04C10_4M_1440P_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_NEXTCHIP_N6 = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC3332_3M_30FPS = { { 0, 0, 2304, 1296 }, { 2304, 1296 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC3335_3M_30FPS = { { 0, 0, 2304, 1296 }, { 2304, 1296 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC3338_3M_30FPS = { { 0, 0, 2304, 1296 }, { 2304, 1296 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC2336_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC2336_1L_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC1346_1L_1M_30FPS = { { 0, 0, 1280, 720 }, { 1280, 720 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC501AI_2L_5M_30FPS = { { 0, 0, 2880, 1620 }, { 2880, 1620 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC531AI_2L_5M_30FPS = { { 0, 0, 2880, 1620 }, { 2880, 1620 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC5336_2L_5M_30FPS = { { 0, 0, 2880, 1618 }, { 2880, 1618 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_GC2093_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_RGGB, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_GC4023_4M_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_RGGB, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_GC4653_4M_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_GRBG, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_GC5603_5M_30FPS = { { 0, 0, 2880, 1620 }, { 2880, 1620 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC035GS_480P_120FPS = { { 0, 0, 640, 480 }, { 640, 480 },
						120, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_MIS2008_1080P_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_RGGB, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_MIS4001_4M_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 }, 
						30, BAYER_GRBG, WDR_MODE_NONE, 0};
...
CVI_S32 SAMPLE_COMM_ISP_GetIspAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S *pstPubAttr)
{
	...
	case SOI_F38P_MIPI_2M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_F38P_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;

	case SOI_F38P_MIPI_2M_15FPS_10BIT_WDR2TO1:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_F38P_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
	...
	case SOI_K06_MIPI_4M_25FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_K06_4M_25FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case OV_OS02H10_MIPI_2M_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS02H10_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case OV_OS02H10_MIPI_2M_30FPS_12BIT_WDR2TO1:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS02H10_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
		break;
	case OV_OS03B10_MIPI_3M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS03B10_3M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case OV_OS04A10_MIPI_4M_1440P_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS04A10_4M_1440P_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case OV_OS04C10_MIPI_4M_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS04C10_4M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case OV_OS04C10_MIPI_4M_1440P_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS04C10_4M_1440P_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case SMS_SC3332_MIPI_3M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC3332_3M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case SMS_SC3335_SLAVE_MIPI_3M_30FPS_10BIT:
		...
		break;
	case SMS_SC3338_MIPI_3M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC3338_3M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case SMS_SC2336_1L_MIPI_2M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC2336_1L_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case SMS_SC1346_1L_MIPI_1M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC1346_1L_1M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case SMS_SC531AI_2L_MIPI_5M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC531AI_2L_5M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case SMS_SC5336_2L_MIPI_5M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC5336_2L_5M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case GCORE_GC4023_MIPI_4M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_GC4023_4M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;

	case GCORE_GC4653_MIPI_4M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_GC4653_4M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case GCORE_GC5603_MIPI_5M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_GC5603_5M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case IMGDS_MIS2008_MIPI_2M_1080P_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_MIS2008_1080P_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case IMGDS_MIS4001_MIPI_4M_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_MIS4001_4M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
...
static char *SAMPLE_COMM_ISP_BbjName(SAMPLE_SNS_TYPE_E enSnsType)
{
    switch (enSnsType) {
		...
		case SOI_K06_MIPI_4M_25FPS_10BIT:
			return "stSnsK06_Obj";
		case SMS_SC3338_MIPI_3M_30FPS_10BIT:
			return "stSnsSC3338_Obj";
		case SMS_SC1346_1L_MIPI_1M_30FPS_10BIT:
			return "stSnsSC1346_1L_Obj";
		case GCORE_GC5603_MIPI_5M_30FPS_10BIT:
			return "stSnsGc5603_Obj";
		case IMGDS_MIS2008_MIPI_2M_1080P_30FPS_12BIT:
		 	return "stSnsMIS2008_Obj";
		case IMGDS_MIS4001_MIPI_4M_30FPS_12BIT:
			return "stSnsMIS4001_Obj";
		case SMS_SC5336_2L_MIPI_5M_30FPS_10BIT:
...
CVI_VOID *SAMPLE_COMM_ISP_GetSnsObj(CVI_U32 u32SnsId)
{
	...
	case SOI_F35_SLAVE_MIPI_2M_30FPS_10BIT_WDR2TO1:
		...
		break;
#endif
#if defined(SENSOR_SOI_F38P)
	case SOI_F38P_MIPI_2M_30FPS_10BIT:
	case SOI_F38P_MIPI_2M_15FPS_10BIT_WDR2TO1:
		pSnsObj = &stSnsF38P_Obj;
		break;
#endif
	...
	case SOI_K06_MIPI_4M_25FPS_10BIT:
		return &stSnsK06_Obj;
#endif
#if defined(SENSOR_OV_OS02H10)
	case OV_OS02H10_MIPI_2M_30FPS_12BIT:
	case OV_OS02H10_MIPI_2M_30FPS_12BIT_WDR2TO1:
		pSnsObj = &stSnsOs02h10_Obj;
		break;
#endif
#if defined(SENSOR_OV_OS03B10)
	case OV_OS03B10_MIPI_3M_30FPS_10BIT:
		pSnsObj = &stSnsOs03b10_Obj;
		break;
#endif
	...
	case SMS_SC3335_SLAVE_MIPI_3M_30FPS_10BIT:
		...
		break;
#endif
#if defined(SENSOR_SMS_SC3338)
	case SMS_SC3338_MIPI_3M_30FPS_10BIT:
		pSnsObj = &stSnsSC3338_Obj;
		break;
#endif
	...
	case GCORE_GC4653_MIPI_4M_30FPS_10BIT:
		return &stSnsGc4653_Obj;
#endif
#if defined(SENSOR_GCORE_GC5603)
	case GCORE_GC5603_MIPI_5M_30FPS_10BIT:
		return &stSnsGc5603_Obj;
#endif
	...
	case IMGDS_MIS2008_MIPI_2M_1080P_30FPS_12BIT:
		...
		break;
#endif
#if defined(SENSOR_IMGDS_MIS4001)
	case IMGDS_MIS4001_MIPI_4M_30FPS_12BIT:
		return &stSnsMIS4001_Obj;
#endif
	default:
