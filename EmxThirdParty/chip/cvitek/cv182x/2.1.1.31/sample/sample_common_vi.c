...
VI_DEV_ATTR_S DEV_ATTR_OS02H10_2M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_OS03B10_3M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_OS04A10_4M_1440P_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_OS04C10_4M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_OS04C10_4M_1440P_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_F38P_2M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_K06_4M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC3332_3M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC3338_3M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC2336_1L_2M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC1346_1L_1M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC531AI_2L_5M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC5336_2L_5M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_GC4023_4M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_GC5603_5M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_MIS2008_1080P_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_MIS4001_4M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_CHN_ATTR_S CHN_ATTR_2880x1618_420_SDR8_LINEAR = {
	{2880, 1618},
	PIXEL_FORMAT_YUV_PLANAR_420,
	DYNAMIC_RANGE_SDR8,
	VIDEO_FORMAT_LINEAR,
...
CVI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S *pstViDevAttr)
{
	...
	case OV_OS02H10_MIPI_2M_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_OS02H10_2M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case OV_OS03B10_MIPI_3M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_OS03B10_3M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	case OV_OS04A10_MIPI_4M_1440P_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_OS04A10_4M_1440P_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case OV_OS04C10_MIPI_4M_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_OS04C10_4M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case OV_OS04C10_MIPI_4M_1440P_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_OS04C10_4M_1440P_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SOI_F38P_MIPI_2M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_F38P_2M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SOI_K06_MIPI_4M_25FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_K06_4M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SMS_SC3332_MIPI_3M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC3332_3M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SMS_SC3338_MIPI_3M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC3338_3M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SMS_SC2336_1L_MIPI_2M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC2336_1L_2M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	case SMS_SC1346_1L_MIPI_1M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC1346_1L_1M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SMS_SC531AI_2L_MIPI_5M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC531AI_2L_5M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	case SMS_SC5336_2L_MIPI_5M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC5336_2L_5M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case GCORE_GC4023_MIPI_4M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_GC4023_4M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case GCORE_GC5603_MIPI_5M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_GC5603_5M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case IMGDS_MIS2008_MIPI_2M_1080P_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_MIS2008_1080P_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	case IMGDS_MIS4001_MIPI_4M_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_MIS4001_4M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
...
CVI_S32 SAMPLE_COMM_VI_GetChnAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_CHN_ATTR_S *pstChnAttr)
{
	...
	case SMS_SC531AI_2L_MIPI_5M_30FPS_10BIT:
		...
		break;
	case SMS_SC5336_2L_MIPI_5M_30FPS_10BIT:
		memcpy(pstChnAttr, &CHN_ATTR_2880x1618_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
		break;
	}
	return CVI_SUCCESS;
}
...
static const char *snsr_type_name[SAMPLE_SNS_TYPE_BUTT] = {
	...
	"OV_OS02H10_MIPI_2M_30FPS_12BIT",
	"OV_OS03B10_MIPI_3M_30FPS_10BIT",
	...
	"SMS_SC3338_MIPI_3M_30FPS_10BIT",
	...
	"GCORE_GC5603_MIPI_5M_30FPS_10BIT",
	...
	"IMGDS_MIS4001_MIPI_4M_30FPS_12BIT",
	/* ------ LINEAR END ------*/
	...
	"OV_OS02H10_MIPI_2M_30FPS_12BIT_WDR2TO1",
	...
	"SOI_F38P_MIPI_2M_30FPS_10BIT_WDR2TO1",
