...
typedef struct _VENC_ATTR_S {
	...
	CVI_BOOL bSliceSplitEnbale;		///< slice split feature, now only support for h265
	CVI_U32	 u32SliceSplitNum;		///< slice split number in one frame, default: 2
