...
typedef struct _ISP_YNR_MANUAL_ATTR_S {
	...
	CVI_U8 NoiseCoringBaseLuma[YNR_CORING_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseCoringBaseOffset[YNR_CORING_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseCoringAdvLuma[YNR_CORING_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseCoringAdvOffset[YNR_CORING_NUM]; /*RW; Range:[0x0, 0xff]*/
...
typedef struct _ISP_YNR_AUTO_ATTR_S {
	...
	CVI_U8 NoiseCoringBaseLuma[YNR_CORING_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseCoringBaseOffset[YNR_CORING_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseCoringAdvLuma[YNR_CORING_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 NoiseCoringAdvOffset[YNR_CORING_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
} ISP_YNR_AUTO_ATTR_S;
...
typedef struct _ISP_SHARPEN_MANUAL_ATTR_S {
	...
	CVI_U16 LumaAdpCoring[SHARPEN_LUT_NUM]; /*RW; Range:[0x0, 0x3ff]*/
...
typedef struct _ISP_SHARPEN_AUTO_ATTR_S {
	...
	CVI_U16 LumaAdpCoring[SHARPEN_LUT_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
...
typedef struct _ISP_TNR_MANUAL_ATTR_S {
	...
	CVI_U8 MtDetectUnit; /*RW; Range:[3, 6]*/
...
typedef struct _ISP_TNR_AUTO_ATTR_S {
	CVI_U8 MergeMode[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0, 1]*/
	...
	CVI_U8 MtDetectUnit[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[3, 6]*/
...
typedef struct _ISP_DEMOSAIC_EE_MANUAL_ATTR_S {
	CVI_BOOL EdgeEnhanceEnable; /*RW; Range:[0, 1]*/
...
typedef struct _ISP_DEMOSAIC_EE_AUTO_ATTR_S {
	CVI_BOOL EdgeEnhanceEnable[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0, 1]*/
...
typedef struct _ISP_FSWDR_AUTO_ATTR_S {
	...
	CVI_U8 MergeModeAlpha[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
	...
	CVI_U8 WDRCombineSNRAwareToleranceLevel[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xff]*/
...
typedef struct _ISP_DRC_MANUAL_ATTR_S {
	CVI_U16 NLDetailDarkGain[4]; /*RW; Range:[0x0, 0xfff]*/
	CVI_S32 NLDetailDarkAmplitude[4]; /*RW; Range:[0, 104875]*/
	CVI_U16 NLDetailBrightGain[4]; /*RW; Range:[0x0, 0xfff]*/
	CVI_S32 NLDetailBrightAmplitude[4]; /*RW; Range:[0, 104875]*/
	CVI_U32 TargetYScale; /*RW; Range:[0x0, 0x800]*/
	CVI_U32 SETargetYScale; /*RW; Range:[0x0, 0x800]*/
	...
	CVI_U16 HdrStrength; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 DarkOffset; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 SdrGlobalGamma; /*RW; Range:[0x0, 0xfff]*/
	CVI_U16 SdrDarkGamma; /*RW; Range:[0x0, 0xfff]*/
	CVI_U16 SdrContrastGainDark; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 SdrContrastGainGlobal; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 SdrGlobalTargetYScale; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 SdrDarkTargetYScale; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 SdrStrength; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 ContrastGain; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 DarkToneRange; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 BritStrength; /*RW; Range:[0x0, 0xff]*/
} ISP_DRC_MANUAL_ATTR_S;

typedef struct _ISP_DRC_AUTO_ATTR_S {
	CVI_U16 NLDetailDarkGain[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_S32 NLDetailDarkAmplitude[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0, 104875]*/
	CVI_U16 NLDetailBrightGain[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_S32 NLDetailBrightAmplitude[4][ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0, 104875]*/
	CVI_U32 TargetYScale[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0x800]*/
	CVI_U32 SETargetYScale[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0x800]*/
	CVI_U32 LETargetYScale[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0x800]*/
	CVI_U16 ContrastDarkMinThrd[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_U16 ContrastDarkMaxThrd[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xfff]*/
	...
	CVI_U16 ContrastBrightMinThrd[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_U16 ContrastBrightMaxThrd[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xfff]*/
	...
	CVI_U16 HdrStrength[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 DarkOffset[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 SdrGlobalGamma[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_U16 SdrDarkGamma[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xfff]*/
	CVI_U16 SdrContrastGainDark[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 SdrContrastGainGlobal[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 SdrGlobalTargetYScale[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U8 SdrDarkTargetYScale[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 SdrStrength[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 ContrastGain[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 DarkToneRange[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
	CVI_U16 BritStrength[ISP_AUTO_LV_NUM]; /*RW; Range:[0x0, 0xff]*/
} ISP_DRC_AUTO_ATTR_S;

typedef struct _ISP_DRC_ATTR_S {
	CVI_BOOL Enable; /*RW; Range:[0, 1]*/
	CVI_BOOL NLDetailEnhanceEn; /*RW; Range:[0, 0x1]*/
	CVI_BOOL SdrDarkToneAdaptEn; /*RW; Range:[0, 0x1]*/
	CVI_BOOL SdrGlobalToneAdaptEn; /*RW; Range:[0, 0x1]*/
	CVI_U8 TuningMode; /*RW; Range:[0x0, 0x4]*/
	CVI_U8 ToneCurveSelect; /*RW; Range:[0x0, 0x1]*/
	CVI_U8 SdrToneCurveSelect; /*RW; Range:[0x0, 0x2]*/
	...
	CVI_U8 DRangeFltScale; /*RW; Range:[0x0, 0xa]*/
	CVI_U8 DRangeFltCoef; /*RW; Range:[0x0, 0x80]*/
	CVI_U8 SpatialFltScale; /*RW; Range:[0x0, 0x7]*/
	CVI_U8 SpatialFltCoef; /*RW; Range:[0x0, 0x1f]*/
	CVI_U32 TargetYLowBound; /*RW; Range:[0x0, 0xff]*/
	CVI_U32 TargetYHighBound; /*RW; Range:[0x0, 0xff]*/
	CVI_U32 SETargetYLowBound; /*RW; Range:[0x0, 0xff]*/
	CVI_U32 SETargetYHighBound; /*RW; Range:[0x0, 0xff]*/
	CVI_U32 LETargetYLowBound; /*RW; Range:[0x0, 0xff]*/
	CVI_U32 LETargetYHighBound; /*RW; Range:[0x0, 0xff]*/
	CVI_U32 LocalToneEn; /*RW; Range:[0x0, 0x1]*/
	CVI_U32 ToneCurveSmooth; /*RW; Range:[0x0, 0xbb8]*/
	CVI_U8 PwlEn; /*RW; Range:[0x0, 0x1]*/
...
typedef struct _ISP_YCONTRAST_MANUAL_ATTR_S {
	CVI_U16 YContrast;
	CVI_U16 YcontrastCenterLuma;
} ISP_YCONTRAST_MANUAL_ATTR_S;

typedef struct _ISP_YCONTRAST_AUTO_ATTR_S {
	CVI_U16 YContrast[ISP_AUTO_LV_NUM];
	CVI_U16 YcontrastCenterLuma[ISP_AUTO_LV_NUM];
