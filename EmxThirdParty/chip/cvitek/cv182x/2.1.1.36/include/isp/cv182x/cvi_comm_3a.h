...
typedef struct _CVI_ISP_FACE_DETECT_INFO {
	...
	CVI_U8	u8HDNum;
	CVI_U16 u16HDPosX[MAX_FACE_NUM];
	CVI_U16 u16HDPosY[MAX_FACE_NUM];
	CVI_U16 u16HDWidth[MAX_FACE_NUM];
	CVI_U16 u16HDHeight[MAX_FACE_NUM];
	CVI_U16 u16FrameWidth;
	CVI_U16 u16FrameHeight;
} CVI_ISP_FACE_DETECT_INFO;


#define AWB_DBG_VER	(10)
...
typedef struct _AWB_DBG_S {
	...
	CVI_ISP_FACE_DETECT_INFO stFace;
	CVI_U32 u32Reserve[32];
} s_AWB_DBG_S;
