...
typedef enum _SAMPLE_SNS_TYPE_E {
	...
	SOI_F38P_MIPI_2M_15FPS_10BIT_WDR2TO1,
...
extern RGN_PALETTETABLE_S overlay_palette[256];
...
CVI_S32 SAMPLE_COMM_REGION_SetBitMap(RGN_HANDLE Handle, const char *filename, PIXEL_FORMAT_E pixelFormat);
