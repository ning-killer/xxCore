...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX335_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 }, 30, BAYER_RGGB, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX385_2M_60FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 }, 50, BAYER_RGGB, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS04C10_4M_1440P_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS02D10_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_OS02K10_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC401AI_4M_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC401AI_3M_30FPS = { { 0, 0, 2304, 1296 }, { 2304, 1296 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC4210_4M_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC4238_4M_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						25, BAYER_BGGR, WDR_MODE_NONE, 0};
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_GC1054_1M_30FPS = { { 0, 0, 1280, 720 }, { 1280, 720 },
						25, BAYER_RGGB, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_TP2850_2M_30FPS = { { 0, 0, 1920, 1080 }, { 1920, 1080 },
						30, BAYER_GRBG, WDR_MODE_NONE, 0};
ISP_PUB_ATTR_S ISP_PUB_ATTR_TP2850_4M_30FPS = { { 0, 0, 2560, 1440 }, { 2560, 1440 },
						30, BAYER_GRBG, WDR_MODE_NONE, 0};
...
CVI_S32 SAMPLE_COMM_ISP_GetIspAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S *pstPubAttr)
{
	...
	case SONY_IMX385_MIPI_2M_30FPS_12BIT_WDR2TO1:
		...
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
		break;
	case SONY_IMX385_MIPI_2M_60FPS_12BIT_WDR2TO1:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX385_2M_60FPS, sizeof(ISP_PUB_ATTR_S));
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
		break;
	...
	/* fallthrough */
	case OV_OS04C10_SLAVE_MIPI_4M_1440P_30FPS_12BIT:
	...
	/* fallthrough */
	case OV_OS04C10_SLAVE_MIPI_4M_1440P_30FPS_10BIT_WDR2TO1:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS04C10_4M_1440P_30FPS, sizeof(ISP_PUB_ATTR_S));
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
		break;
	case OV_OS02D10_MIPI_2M_30FPS_10BIT:
	case OV_OS02D10_SLAVE_MIPI_2M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS02D10_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case OV_OS02K10_SLAVE_MIPI_2M_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS02K10_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case OV_OS04A10_MIPI_4M_1440P_30FPS_12BIT:
	case OV_OS04A10_SLAVE_MIPI_4M_1440P_30FPS_12BIT:
	...
	case OV_OS04A10_SLAVE_MIPI_4M_1440P_30FPS_10BIT_WDR2TO1:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_OS04A10_4M_1440P_30FPS, sizeof(ISP_PUB_ATTR_S));
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
		break;
	...
	case SMS_SC401AI_MIPI_3M_30FPS_10BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC401AI_3M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case SMS_SC4210_MIPI_4M_30FPS_10BIT_WDR2TO1:
		...
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
		break;
	case SMS_SC4238_MIPI_4M_30FPS_12BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_SC4238_4M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	...
	case SONY_IMX335_MIPI_2M_30FPS_10BIT_WDR2TO1:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX335_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		pstPubAttr->enWDRMode = WDR_MODE_2To1_LINE;
		break;
	...
	case TECHPOINT_TP2850_MIPI_2M_30FPS_8BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_TP2850_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	case TECHPOINT_TP2850_MIPI_4M_30FPS_8BIT:
		memcpy(pstPubAttr, &ISP_PUB_ATTR_TP2850_4M_30FPS, sizeof(ISP_PUB_ATTR_S));
		break;
	default:
		s32Ret = CVI_FAILURE;
		break;
...
CVI_VOID *SAMPLE_COMM_ISP_GetSnsObj(CVI_U32 u32SnsId)
{
	...
	case OV_OS04A10_MIPI_4M_1440P_30FPS_10BIT_WDR2TO1:
		...
		break;
#endif
#if defined(SENSOR_OV_OS04A10_SLAVE)
	case OV_OS04A10_SLAVE_MIPI_4M_1440P_30FPS_12BIT:
	case OV_OS04A10_SLAVE_MIPI_4M_1440P_30FPS_10BIT_WDR2TO1:
		pSnsObj = &stSnsOs04a10_Slave_Obj;
		break;
#endif
	...
	case SMS_SC4210_MIPI_4M_30FPS_10BIT_WDR2TO1:
		...
		break;
#endif
#if defined(SENSOR_SMS_SC4238)
	case SMS_SC4238_MIPI_4M_30FPS_12BIT:
		pSnsObj = &stSnsSC4238_Obj;
		break;
#endif
