...
VI_DEV_ATTR_S DEV_ATTR_OS02D10_2M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_OS02K10_2M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC401AI_3M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_SC4238_4M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_TECHPOINT_TP2850_2M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
VI_DEV_ATTR_S DEV_ATTR_TECHPOINT_TP2850_4M_BASE = {
	VI_MODE_MIPI,
	VI_WORK_MODE_1Multiplex,
	VI_SCAN_PROGRESSIVE,
	{-1, -1, -1, -1},
...
CVI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S *pstViDevAttr)
{
	...
	case OV_OS02D10_SLAVE_MIPI_2M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_OS02D10_2M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	case OV_OS02K10_SLAVE_MIPI_2M_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_OS02K10_2M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SMS_SC401AI_MIPI_3M_30FPS_10BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC401AI_3M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case SMS_SC4238_MIPI_4M_30FPS_12BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_SC4238_4M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	...
	case TECHPOINT_TP2850_MIPI_2M_30FPS_8BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_TECHPOINT_TP2850_2M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	case TECHPOINT_TP2850_MIPI_4M_30FPS_8BIT:
		memcpy(pstViDevAttr, &DEV_ATTR_TECHPOINT_TP2850_4M_BASE, sizeof(VI_DEV_ATTR_S));
		break;
	}
...
#endif
#ifdef SUPPORT_DOUBLE_SENSOR_ISP
            ISP_STITCH_ATTR_S stStitchAttr;/*设置以哪个sensor isp为主*/
            stStitchAttr.enable = CVI_TRUE;
            stStitchAttr.bMainPipe = CVI_FALSE;
            CVI_ISP_SetStitchAttr(1,&stStitchAttr);
            stStitchAttr.bMainPipe =  CVI_TRUE;
            CVI_ISP_SetStitchAttr(0,&stStitchAttr);
            SAMPLE_PRT("CVI_ISP_SetStitchAttr  stitch attr !\n");
#endif
...
static const char *snsr_type_name[SAMPLE_SNS_TYPE_BUTT] = {
	...
	"OV_OS04C10_SLAVE_MIPI_4M_1440P_30FPS_12BIT",
	...
	"OV_OS04A10_SLAVE_MIPI_4M_1440P_30FPS_12BIT",
	...
	"SMS_SC4238_MIPI_4M_30FPS_12BIT",
	...
	"OV_OS04C10_SLAVE_MIPI_4M_1440P_30FPS_10BIT_WDR2TO1",
	"OV_OS04A10_MIPI_4M_1440P_30FPS_10BIT_WDR2TO1",
	"OV_OS04A10_SLAVE_MIPI_4M_1440P_30FPS_10BIT_WDR2TO1",
	...
	"SONY_IMX385_MIPI_2M_60FPS_12BIT_WDR2TO1",
