...
typedef union _ISP_MODULE_CTRL_U {
	...
	struct {
		...
		CVI_U64 bitBypassWBGain : 1;  /* RW;[2] */
		CVI_U64 bitBypassDis : 1;  /* RW;[3] */
		CVI_U64 bitBypassFpn : 1;  /* RW;[4] */
		CVI_U64 bitBypassMotion : 1;  /* RW;[5] */
		CVI_U64 bitBypassDpc : 1;  /* RW;[6] */
		CVI_U64 bitBypassCrosstalk : 1;  /* RW;[7] */
		CVI_U64 bitBypassMlsc : 1;  /* RW;[8] */
		CVI_U64 bitBypassFusion : 1;  /* RW;[9] */
		CVI_U64 bitBypassDrc : 1;  /* RW;[10] */
		CVI_U64 bitBypassBnr : 1;  /* RW;[11] */
		CVI_U64 bitBypassDemosaic : 1;  /* RW;[12] */
		CVI_U64 bitBypassCcm : 1;  /* RW;[13] */
		CVI_U64 bitBypassGamma : 1;  /* RW;[14] */
		CVI_U64 bitBypassDehaze : 1;  /* RW;[15] */
		CVI_U64 bitBypassHsv : 1;  /* RW;[16] */
		CVI_U64 bitBypass3dnr : 1;  /* RW;[17] */
		CVI_U64 bitBypassYnr : 1;  /* RW;[18] */
		CVI_U64 bitBypassCnr : 1;  /* RW;[19] */
		CVI_U64 bitBypassCac : 1;  /* RW;[20] */
		CVI_U64 bitBypassDci : 1;  /* RW;[21] */
		CVI_U64 bitBypassYee : 1;  /* RW;[22] */
		CVI_U64 bitBypassYcontrast : 1;  /* RW;[23] */
		CVI_U64 bitBypassClut : 1;  /* RW;[24] */
		CVI_U64 bitBypassMono : 1;  /* RW;[25] */
		CVI_U64 bitRsv : 38; /* RW: [26:63] */
	};
} ISP_MODULE_CTRL_U;
...
typedef struct _ISP_BLACK_LEVEL_MANUAL_ATTR_S {
	CVI_U16 OffsetR; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 OffsetGr; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 OffsetGb; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 OffsetB; /*RW; Range:[0x0, 0x3ff]*/
...
typedef struct _ISP_BLACK_LEVEL_AUTO_ATTR_S {
	CVI_U16 OffsetR[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 OffsetGr[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 OffsetGb[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
	CVI_U16 OffsetB[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x3ff]*/
...
CVI_BOOL migration_test(VI_PIPE ViPipe);
// Backward Compatible
