...
#define IS_CHIP_CV182X(x) (((x) == CVI1822) || ((x) == CVI1826) || ((x) == CVI1821))
...
#define VI_PIXEL_FORMAT                     PIXEL_FORMAT_YUV_PLANAR_420
...
#define CVI_VI_CHN_2_BUF                    (0)
#define CVI_VI_CHN_3_BUF                    (0)
#define CVI_VI_BUF                          (CVI_VI_CHN_0_BUF + CVI_VI_CHN_1_BUF)
