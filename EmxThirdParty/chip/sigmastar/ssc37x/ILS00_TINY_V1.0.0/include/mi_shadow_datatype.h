...
typedef enum
{
    E_MI_SHADOW_CALLBACK_EVENT_ONBINDINPUTPORT,
    E_MI_SHADOW_CALLBACK_EVENT_ONBINDOUTPUTPORT,
    E_MI_SHADOW_CALLBACK_EVENT_ONUNBINDINPUTPORT,
    E_MI_SHADOW_CALLBACK_EVENT_ONUNBINDOUTPUTPORT,
    E_MI_SHADOW_CALLBACK_EVENT_BINDMAX,
