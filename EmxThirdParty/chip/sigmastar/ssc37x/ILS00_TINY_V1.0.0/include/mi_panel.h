...
#define PANEL_SUB_VERSION   15
#define MACRO_TO_STR(macro) #macro
#define PANEL_VERSION_STR(major_version, sub_version)                                                                 \
    (                                                                                                                 \
        {                                                                                                             \
            char *tmp =                                                                                               \
                sub_version / 100  ? "mi_panel_version_" MACRO_TO_STR(major_version) "." MACRO_TO_STR(sub_version)    \
                : sub_version / 10 ? "mi_panel_version_" MACRO_TO_STR(major_version) ".0" MACRO_TO_STR(sub_version)   \
                                   : "mi_panel_version_" MACRO_TO_STR(major_version) ".00" MACRO_TO_STR(sub_version); \
            tmp;                                                                                                      \
        })
