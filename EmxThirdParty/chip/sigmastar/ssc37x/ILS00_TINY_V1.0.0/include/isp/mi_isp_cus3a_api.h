...
//#include <pthread.h>
#include "mi_common.h"
#include "isp/maruko/mi_isp_hw_dep_datatype.h"
...
inline MI_S32 MI_ISP_EnableUserspace3A(MI_U32 DevId, MI_U32 Channel)
{
    return 0;
}
inline MI_S32 MI_ISP_DisableUserspace3A(MI_U32 DevId, MI_U32 Channel)
{
    return 0;
}
#endif
