...
extern "C"
{
    ...
    MI_S32 MI_VENC_GetSmartVideoCoding(MI_VENC_DEV VeDev, MI_VENC_CHN VeChn,
                                       MI_VENC_SmartVideoCoding_t *pstSmartVideoCoding);
	MI_S32 MI_VENC_SetSmartVideoCodingEx(MI_VENC_DEV VeDev, MI_VENC_CHN VeChn,
                                       MI_VENC_SmartVideoCodingEx_t *pstSmartVideoCodingEx);
    ...
    MI_S32 MI_VENC_GetH265SliceSplit(MI_VENC_DEV VeDev, MI_VENC_CHN VeChn,
                                     MI_VENC_ParamH265SliceSplit_t *pstSliceSplit);
    MI_S32 MI_VENC_SetH265InterPred(MI_VENC_DEV VeDev, MI_VENC_CHN VeChn,
