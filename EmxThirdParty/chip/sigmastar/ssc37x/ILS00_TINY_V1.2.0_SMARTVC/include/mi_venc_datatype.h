...
typedef struct MI_VENC_SmartVideoCodingEx_s
{
    MI_U32 u32BitRatePercent;
} MI_VENC_SmartVideoCodingEx_t;
...
typedef MI_VENC_AttrH264Ubr_t MI_VENC_AttrH265Ubr_t;
...
{
    MI_S32 (*rc_init)(MI_VENC_DEV VeDev, MI_VENC_CHN VeChn, MI_VENC_UserRcChnAttr_t *pstAttr);
    MI_S32 (*rc_deinit)(MI_VENC_DEV VeDev, MI_VENC_CHN VeChn);
    MI_S32(*rc_calc)
    ...
    MI_S32 (*rc_attr_change)(MI_VENC_DEV VeDev, MI_VENC_CHN VeChn, MI_VENC_UserRcChnAttr_t *pstAttr);
