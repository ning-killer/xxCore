...
#define NR3D_C_BY_Y_NUM              16
#define NR3D_Y_BY_Y_NUM              16
...
#define WDR_BY_OPS_CNT               8
#define WDR_LCE_TONE_NUM             4
#define WDR_LCE_BY_Y_NUM             9
#define WDR_LCE_LUT_X_NUM            12
#define WDR_LCE_LUT_Y_NUM            13
#define WDR_NR_LUT_X_NUM             12
#define WDR_NR_LUT_Y_NUM             13
#define WDR_JND_LUT_X_NUM            8
#define WDR_JND_LUT_Y_NUM            9
...
{
    MI_U8  u8MdThd_C;              //0~255
    MI_U8  u8MdThd_Y;               //0~255
    MI_U16 u16MdGain_C;            //0~1023
    MI_U16 u16MdGain_Y;             //0~1023
    MI_U8  u8TfStr_Y;                  //0~64
    MI_U8  u8TfStr_C;                //0~64
    MI_U8  u8MdThd_CByY[NR3D_C_BY_Y_NUM];         //0~255
    MI_U8  u8MdThd_YByY[NR3D_Y_BY_Y_NUM];          //0~255
    MI_U8  u8MdGain_CByY[NR3D_C_BY_Y_NUM];        //0~255
    MI_U8  u8MdGain_YByY[NR3D_Y_BY_Y_NUM];         //0~255
...
typedef struct MI_ISP_IQ_SharpnessParam_s
{
    ...
    MI_U16 u16MidRatioUDByMot[SHARPNESS_BY_MOT_NUM];   //0 ~ 256
    MI_U16 u16HighRatioUDByMot[SHARPNESS_BY_MOT_NUM];  //0 ~ 256
    MI_U16 u16MidRatioDByMot[SHARPNESS_BY_MOT_NUM];    //0 ~ 256
    MI_U16 u16HighRatioDByMot[SHARPNESS_BY_MOT_NUM];   //0 ~ 256
    MI_U16 u16HighRatioUDByState[SHARPNESS_FREQ_NUM]; //0 ~ 256
    MI_U16 u16HighRatioDByState[SHARPNESS_FREQ_NUM];  //0 ~ 256
    MI_U8  u8DetailGainUDByMot[SHARPNESS_BY_MOT_NUM];  //0 ~ 255
    MI_U16 u16DirRatioByState[SHARPNESS_BY_STATE_NUM];    //0 ~ 256
    MI_U8  u8StdAdjByMot[SHARPNESS_BY_MOT_NUM];       // 0 ~ 63
    MI_U8  u8StdAdjByY[SHARPNESS_BY_Y_NUM];           // 0 ~ 255
    MI_U8  u8GainByStd[SHARPNESS_BY_STD];           //0 ~ 255
    MI_U8  u8CorByY[SHARPNESS_BY_Y_NUM];              //0 ~ 255
    MI_U8  u8CorByMot[SHARPNESS_BY_MOT_NUM];           //0 ~ 255
    MI_U8  u8OverShootGain;          //0 ~ 255
    MI_U8  u8UnderShootGain;         //0 ~ 255
    MI_U8  u8SclByY[SHARPNESS_BY_Y_NUM];              //0 ~ 255
    MI_U16 u16EdgeKillLut[SHARPNESS_BY_STD];        //0 ~ 1023
...
typedef struct MI_ISP_IQ_SharpnessExParam_s
{
   MI_ISP_IQ_Bool_e  bDbgEn;                //0 ~ 1
    ...
    MI_U16         u16SmoDiffThByY[SHARPNESS_EX_BY_Y_NUM];    //0 ~ 1023
    MI_U8          u8SmoBlendByStd[SHARPNESS_EX_BY_STD_NUM];    //0 ~ 16
    MI_U8          u8SmoBlendByMot[SHARPNESS_EX_BY_MOT_NUM];   //0 ~ 63
    MI_U8          u8SblLut[SHARPNESS_EX_BY_SFT_NUM];           //0 ~ 127
    MI_U8          u8EdgeLabelSel;        //0 ~ 1
    MI_U8          u8GainByStdSft[SHARPNESS_EX_BY_SFT_NUM];     //0 ~ 15
    MI_U8          u8EdgeKillLutSft[SHARPNESS_EX_BY_SFT_NUM];   //0 ~ 15
...
typedef struct MI_ISP_IQ_WdrParam_s
{
    ...
    MI_U16        u16StrengthByOpsCnt[WDR_BY_OPS_CNT];   //0~4095
    MI_U8         u8DeSatSrcSel;            //0~2
    MI_U8         u8DeSatLut[WDR_BY_Y_NUM];           //0~255
    MI_U16		  u16WDRsatdn[WDR_BY_Y_NUM];			//0~1023
    MI_U16		  u16WDRsatup[WDR_BY_Y_NUM];			//0~1023
...
typedef struct MI_ISP_IQ_WdrNrParam_s
{
    ...
    MI_U8  u8Nr_Sft[WDR_NR_LUT_X_NUM];     // 1~11
    ...
    MI_U8  u8JND_Sft[WDR_JND_LUT_X_NUM];   // 1~11
    MI_U16 u16JND_Thd[WDR_JND_LUT_Y_NUM];  // 0~4095
    MI_U16 u16JND_Gain[WDR_JND_LUT_Y_NUM]; // 0~4095
