...
typedef enum _MI_VG_RET_E
{
    ...
    MI_VG_RET_INVALID_POLYGONREGION_MAGIC_NUMBER         = 0x1000031B,   /*Invalid POLYGON region magic number*/
    MI_VG_RET_INVALID_POLYGON_REGION_COORDINATE          = 0x1000031C1   /*Invalid polygon region coordinate*/
} MI_VG_RET;
