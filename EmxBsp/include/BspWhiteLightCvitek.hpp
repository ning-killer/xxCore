...
#ifndef EMX_BspWhiteLightCvitek_HPP
#define EMX_BspWhiteLightCvitek_HPP

#include "EmxBsp.hpp"

namespace Emx {

    class BspWhiteLightCvitek : public Bsp::WhiteLight {
    public:
        BspWhiteLightCvitek();

        virtual ~BspWhiteLightCvitek() override;
...
#endif //EMX_BspWhiteLightCvitek_HPP
